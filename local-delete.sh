...
echo "delete the persistent volume for jenkins...."
kubectl delete -f ./kubernetes/jenkins-local-pv.yaml
rm -rf /Users/Shared/Kubernetes/persistent-volumes/default/jenkins
